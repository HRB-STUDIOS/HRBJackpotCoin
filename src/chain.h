...
#ifndef HRBJACKPOTCOIN_CHAIN_H
#define HRBJACKPOTCOIN_CHAIN_H
 ...
 *
 * Ref: https://github.com/hrbjackpotcoin/hrbjackpotcoin/pull/1026
 */
...
public:
    ...
    // HRB Jackpot Coin: Jackpot Accumulators
    CAmount nJackpotMini = 0;
    CAmount nJackpotMinor = 0;
    CAmount nJackpotMajor = 0;
    CAmount nJackpotGrand = 0;
    CAmount nFounderFeeAcc = 0;
