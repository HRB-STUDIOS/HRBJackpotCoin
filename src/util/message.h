...
#ifndef HRBJACKPOTCOIN_UTIL_MESSAGE_H
#define HRBJACKPOTCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's hrbjackpotcoin address, it must refer to a public key.
...
#endif // HRBJACKPOTCOIN_UTIL_MESSAGE_H
