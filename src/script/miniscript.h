...
#ifndef HRBJACKPOTCOIN_SCRIPT_MINISCRIPT_H
#define HRBJACKPOTCOIN_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a hrbjackpotcoin script
...
#endif // HRBJACKPOTCOIN_SCRIPT_MINISCRIPT_H
