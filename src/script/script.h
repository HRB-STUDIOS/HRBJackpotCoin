...
#ifndef HRBJACKPOTCOIN_SCRIPT_SCRIPT_H
#define HRBJACKPOTCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, HRBJackpotCoin always counted CHECKMULTISIGs
...
#endif // HRBJACKPOTCOIN_SCRIPT_SCRIPT_H
