...
#ifndef HRBJACKPOTCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define HRBJACKPOTCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // HRBJACKPOTCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
