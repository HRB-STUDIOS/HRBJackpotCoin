...
static void SetupHRBJackpotCoinUtilArgs(ArgsManager &argsman)
{
...
{
    SetupHRBJackpotCoinUtilArgs(args);
    std::string error;
    ...
    if (HelpRequested(args) || args.IsArgSet("-version")) {
        ...
        std::string strUsage = PACKAGE_NAME " hrbjackpotcoin-util utility version " + FormatFullVersion() + "\n";

        if (args.IsArgSet("-version")) {
            strUsage += FormatParagraph(LicenseInfo());
        } else {
            strUsage += "\n"
                "Usage:  hrbjackpotcoin-util [options] [commands]  Do stuff\n";
            strUsage += "\n" + args.GetHelpMessage();
        }
