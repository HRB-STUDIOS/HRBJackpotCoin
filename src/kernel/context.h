...
#ifndef HRBJACKPOTCOIN_KERNEL_CONTEXT_H
#define HRBJACKPOTCOIN_KERNEL_CONTEXT_H
...
//! passed to external libhrbjackpotcoin_kernel functions which need access to this
...
#endif // HRBJACKPOTCOIN_KERNEL_CONTEXT_H
