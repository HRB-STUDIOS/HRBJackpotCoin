...
#ifndef HRBJACKPOTCOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
#define HRBJACKPOTCOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
...
#endif // HRBJACKPOTCOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
