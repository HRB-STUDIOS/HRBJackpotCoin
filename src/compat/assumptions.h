...
#ifndef HRBJACKPOTCOIN_COMPAT_ASSUMPTIONS_H
#define HRBJACKPOTCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "HRBJackpotCoin cannot be compiled without assertions."
#endif
...
#endif // HRBJACKPOTCOIN_COMPAT_ASSUMPTIONS_H
