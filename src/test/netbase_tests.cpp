...
{
    BOOST_CHECK(TestSplitHost("www.hrbjackpotcoincore.org", "www.hrbjackpotcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.hrbjackpotcoincore.org]", "www.hrbjackpotcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.hrbjackpotcoincore.org:80", "www.hrbjackpotcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.hrbjackpotcoincore.org]:80", "www.hrbjackpotcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.hrbjackpotcoincore.org:65536", "www.hrbjackpotcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.hrbjackpotcoincore.org:0", "www.hrbjackpotcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.hrbjackpotcoincore.org:", "www.hrbjackpotcoincore.org:", 0, false));
}
