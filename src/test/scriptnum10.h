...
#ifndef HRBJACKPOTCOIN_TEST_SCRIPTNUM10_H
#define HRBJACKPOTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from HRBJackpotCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // HRBJACKPOTCOIN_TEST_SCRIPTNUM10_H
