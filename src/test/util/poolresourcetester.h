...
#ifndef HRBJACKPOTCOIN_TEST_UTIL_POOLRESOURCETESTER_H
#define HRBJACKPOTCOIN_TEST_UTIL_POOLRESOURCETESTER_H
...
#endif // HRBJACKPOTCOIN_TEST_UTIL_POOLRESOURCETESTER_H
