...
#ifndef HRBJACKPOTCOIN_QT_WALLETMODEL_H
#define HRBJACKPOTCOIN_QT_WALLETMODEL_H
...
/** Interface to HRBJackpotCoin wallet from Qt view code. */
...
#endif // HRBJACKPOTCOIN_QT_WALLETMODEL_H
