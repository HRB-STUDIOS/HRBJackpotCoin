...
#ifndef HRBJACKPOTCOIN_QT_CLIENTMODEL_H
#define HRBJACKPOTCOIN_QT_CLIENTMODEL_H
...
/** Model for HRBJackpotCoin network client. */
...
#endif // HRBJACKPOTCOIN_QT_CLIENTMODEL_H
