...
#ifndef HRBJACKPOTCOIN_QT_WALLETCONTROLLER_H
#define HRBJACKPOTCOIN_QT_WALLETCONTROLLER_H
...
public:
    ...
    // Create a wallet without showing any dialogs. Returns nullptr on error.
    // Fills warnings if any non-fatal issues occur.
    WalletModel* createWalletSilently(const std::string& name,
...
#endif // HRBJACKPOTCOIN_QT_WALLETCONTROLLER_H