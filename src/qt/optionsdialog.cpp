      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->hrbjackpotcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->hrbjackpotcoinAtStartup);
    ...
    ui->hrbjackpotcoinAtStartup->setToolTip(ui->hrbjackpotcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->hrbjackpotcoinAtStartup->setText(ui->hrbjackpotcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openHRBJackpotCoinConfButton->setToolTip(ui->openHRBJackpotCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new HRBJackpotCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->hrbjackpotcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePShrbontrols);
...
void OptionsDialog::on_openHRBJackpotCoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openHRBJackpotCoinConf())
