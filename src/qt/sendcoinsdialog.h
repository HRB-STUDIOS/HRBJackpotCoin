...
#ifndef HRBJACKPOTCOIN_QT_SENDCOINSDIALOG_H
#define HRBJACKPOTCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending hrbjackpotcoins */
...
#endif // HRBJACKPOTCOIN_QT_SENDCOINSDIALOG_H
