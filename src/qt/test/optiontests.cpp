...
{
    // Test regression https://github.com/hrbjackpotcoin/hrbjackpotcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/hrbjackpotcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/hrbjackpotcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/HRBJackpotCoin/HRBJackpotCoin-Qt.conf and all else left as default,
    // hrbjackpotcoin-qt should set both -listen and -listenonion to false and start successfully.
