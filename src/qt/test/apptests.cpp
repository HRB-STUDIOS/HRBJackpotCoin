...
//! Entry point for HRBJackpotCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &HRBJackpotCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for HRBJackpotCoinGUI tests.
void AppTests::guiTests(HRBJackpotCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &HRBJackpotCoinGUI::consoleShown, this, &AppTests::consoleTests);
