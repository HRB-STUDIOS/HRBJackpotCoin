 ...
 */
#ifndef HRBJACKPOTCOIN_TORCONTROL_H
#define HRBJACKPOTCOIN_TORCONTROL_H
...
/****** HRBJackpotCoin specific TorController implementation ********/
...
#endif // HRBJACKPOTCOIN_TORCONTROL_H
