...
#ifndef HRBJACKPOTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define HRBJACKPOTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // HRBJACKPOTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
