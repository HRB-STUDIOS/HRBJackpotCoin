...
#ifndef HRBJACKPOTCOIN_PROTOCOL_H
#define HRBJACKPOTCOIN_PROTOCOL_H
...
/**
 * HRBJackpotCoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all HRBJackpotCoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // hrbjackpotcoin-development mailing list. Remember that service bits are just
...
#endif // HRBJACKPOTCOIN_PROTOCOL_H
