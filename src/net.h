...
#ifndef HRBJACKPOTCOIN_NET_H
#define HRBJACKPOTCOIN_NET_H
...
public:
     ...
     * @see https://github.com/hrbjackpotcoin/hrbjackpotcoin/issues/21744 for details.
     */
