...
#ifndef HRBJACKPOTCOIN_COMMON_SETTINGS_H
#define HRBJACKPOTCOIN_COMMON_SETTINGS_H
...
//!       https://github.com/hrbjackpotcoin/hrbjackpotcoin/pull/15934/files#r337691812)
...
#endif // HRBJACKPOTCOIN_COMMON_SETTINGS_H
