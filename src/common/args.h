...
#ifndef HRBJACKPOTCOIN_COMMON_ARGS_H
#define HRBJACKPOTCOIN_COMMON_ARGS_H
...
extern const char * const HRBJACKPOTCOIN_CONF_FILENAME;
extern const char * const HRBJACKPOTCOIN_SETTINGS_FILENAME;
...
#endif // HRBJACKPOTCOIN_COMMON_ARGS_H
