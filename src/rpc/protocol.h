...
#ifndef HRBJACKPOTCOIN_RPC_PROTOCOL_H
#define HRBJACKPOTCOIN_RPC_PROTOCOL_H
...
//! HRBJackpotCoin RPC error codes
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in hrbjackpotcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< HRBJackpotCoin is not connected
...
#endif // HRBJACKPOTCOIN_RPC_PROTOCOL_H
