...
#ifndef HRBJACKPOTCOIN_INTERFACES_NODE_H
#define HRBJACKPOTCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a hrbjackpotcoin node (hrbjackpotcoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or hrbjackpotcoin.conf.
...
#endif // HRBJACKPOTCOIN_INTERFACES_NODE_H
