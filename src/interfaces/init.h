...
#ifndef HRBJACKPOTCOIN_INTERFACES_INIT_H
#define HRBJACKPOTCOIN_INTERFACES_INIT_H
...
//! (hrbjackpotcoin-gui, hrbjackpotcoin-node, hrbjackpotcoin-wallet, hrbjackpotcoind, hrbjackpotcoin-qt) and each
...
#endif // HRBJACKPOTCOIN_INTERFACES_INIT_H
