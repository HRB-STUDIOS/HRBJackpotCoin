...
#ifndef HRBJACKPOTCOIN_NODE_CONNECTION_TYPES_H
#define HRBJACKPOTCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/hrbjackpotcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on HRBJackpotCoin’s Peer-to-Peer Network")
...
#endif // HRBJACKPOTCOIN_NODE_CONNECTION_TYPES_H
