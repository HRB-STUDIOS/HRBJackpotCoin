...
#ifndef HRBJACKPOTCOIN_WALLET_WALLETUTIL_H
#define HRBJACKPOTCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! hrbjackpotcoin from opening the wallet, thinking it was newly created, and
...
#endif // HRBJACKPOTCOIN_WALLET_WALLETUTIL_H
