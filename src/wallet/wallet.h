...
#ifndef HRBJACKPOTCOIN_WALLET_WALLET_H
#define HRBJACKPOTCOIN_WALLET_WALLET_H
...
//! Discourage users to set fees higher than this amount (in hrbjacks) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in hrbjacks)
...
public:
    ...
    /** Absolute maximum transaction fee (in hrbjacks) used by default for the wallet */
...
#endif // HRBJACKPOTCOIN_WALLET_WALLET_H
