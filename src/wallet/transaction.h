...
#ifndef HRBJACKPOTCOIN_WALLET_TRANSACTION_H
#define HRBJACKPOTCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this hrbjackpotcoin node, and set to 0 for transactions that were created
...
#endif // HRBJACKPOTCOIN_WALLET_TRANSACTION_H
