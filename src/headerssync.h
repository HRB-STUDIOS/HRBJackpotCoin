...
#ifndef HRBJACKPOTCOIN_HEADERSSYNC_H
#define HRBJACKPOTCOIN_HEADERSSYNC_H
 ...
 *
 * The HRBJackpotCoin protocol does not offer an easy way to determine the work on a
...
#endif // HRBJACKPOTCOIN_HEADERSSYNC_H
