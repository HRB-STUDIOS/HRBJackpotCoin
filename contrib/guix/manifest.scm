...
(define* (make-hrbjackpotcoin-cross-toolchain target
                                       #:key
...
desirable for building HRBJackpotCoin Core release binaries."
...
;; failure; see https://github.com/hrbjackpotcoin/hrbjackpotcoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-hrbjackpotcoin-cross-toolchain target)))
