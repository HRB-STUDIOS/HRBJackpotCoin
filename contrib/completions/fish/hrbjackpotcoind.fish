...
complete --command hrbjackpotcoind --no-files

# Extract options
function __fish_hrbjackpotcoind_get_options
...
complete \
    --command hrbjackpotcoind \
    --arguments "(__fish_hrbjackpotcoind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command hrbjackpotcoind \
...
complete \
    --command hrbjackpotcoind \
    --arguments "(__fish_hrbjackpotcoind_get_options --nofiles)"
