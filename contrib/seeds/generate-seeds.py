...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef HRBJACKPOTCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define HRBJACKPOTCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the hrbjackpotcoin network\n')
    ...
    g.write('#endif // HRBJACKPOTCOIN_CHAINPARAMSSEEDS_H\n')
