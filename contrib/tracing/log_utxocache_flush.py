...
"""Example logging HRBJackpotCoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/hrbjackpotcoind
...
def main(hrbjackpotcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[hrbjackpotcoind_with_usdts])
