HRBJackpotCoin Core version 0.9.4 is now available from:

  https://hrbjackpotcoin.org/bin/0.9.4/
...
this update is incompatible with the HRBJackpotCoin system and could lead to consensus
forks.

HRBJackpotCoin Core released binaries from https://hrbjackpotcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~hrbjackpotcoin/+archive/ubuntu/hrbjackpotcoin
- A third-party or self-compiled HRBJackpotCoin Core

upgrade to HRBJackpotCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
