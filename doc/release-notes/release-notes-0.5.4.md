HRBJackpotCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hrbjackpotcoin/files/HRBJackpotCoin/hrbjackpotcoin-0.5.4/
...
http://gitorious.org/hrbjackpotcoin/hrbjackpotcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix HRBJackpotCoin-Qt notifications under Growl 1.3.
Increase required age of HRBJackpotCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHRBJackpotCoin properly when installing HRBJackpotCoin-Qt over it. (Windows)
