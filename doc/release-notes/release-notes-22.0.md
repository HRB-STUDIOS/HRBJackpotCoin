...
- A new `-rpcwaittimeout` argument to `hrbjackpotcoin-cli` sets the timeout
...
- hrbjackpotcoin/hrbjackpotcoin#21202 Two small clang lock annotation improvements (amitiuttarwar)
...
- hrbjackpotcoin/hrbjackpotcoin#20599 net processing: Tolerate sendheaders and sendcmpct messages before verack (jnewbery)
...
- hrbjackpotcoin/hrbjackpotcoin#21644 p2p, bugfix: use NetPermissions::HasFlag() in CConnman::Bind() (jonatack)
...
- hrbjackpotcoin/hrbjackpotcoin#21238 A few descriptor improvements to prepare for Taproot support (sipa)
...
- hrbjackpotcoin/hrbjackpotcoin#21053 Document {previous,next}blockhash as optional (theStack)
...
- hrbjackpotcoin-core/gui#205, hrbjackpotcoin-core/gui#229 Save/restore TransactionView and recentRequestsView tables column sizes (hebasto)
...
- hrbjackpotcoin/hrbjackpotcoin#21065 make macOS HOST in download-osx generic (fanquake)
...
- hrbjackpotcoin/hrbjackpotcoin#21889 macho: check for control flow instrumentation (fanquake)
...
- hrbjackpotcoin/hrbjackpotcoin#19972 fuzz: Add fuzzing harness for node eviction logic (practicalswift)
...
- hrbjackpotcoin/hrbjackpotcoin#20857 Update documentation in `feature_csv_activation.py` (PiRK)
...
- hrbjackpotcoin/hrbjackpotcoin#21310 zmq test: fix sync-up by matching notification to generated block (theStack)
...
- hrbjackpotcoin/hrbjackpotcoin#21777 Fix `feature_notifications.py` intermittent issue (MarcoFalke)
...
- hrbjackpotcoin/hrbjackpotcoin#21107, hrbjackpotcoin/hrbjackpotcoin#22092 Convert documentation into type annotations (fanquake)
...
- hrbjackpotcoin/hrbjackpotcoin#21447 Always add -daemonwait to known command line arguments (hebasto)
...
- hrbjackpotcoin/hrbjackpotcoin#20830 Update developer notes with signet (jonatack)
...
- hrbjackpotcoin/hrbjackpotcoin#21384 doc: add signet to hrbjackpotcoin.conf documentation (jonatack)
- hrbjackpotcoin/hrbjackpotcoin#21394 Improve comment about protected peers (amitiuttarwar)
- hrbjackpotcoin/hrbjackpotcoin#21398 Update fuzzing docs for afl-clang-lto (MarcoFalke)
- hrbjackpotcoin/hrbjackpotcoin#21444 net, doc: Doxygen updates and fixes in netbase.{h,cpp} (jonatack)
- hrbjackpotcoin/hrbjackpotcoin#21481 Tell howto install clang-format on Debian/Ubuntu (wodry)
- hrbjackpotcoin/hrbjackpotcoin#21567 Fix various misleading comments (glozow)
- hrbjackpotcoin/hrbjackpotcoin#21661 Fix name of script guix-build (Emzy)
- hrbjackpotcoin/hrbjackpotcoin#21672 Remove boostrap info from `GUIX_COMMON_FLAGS` doc (fanquake)
- hrbjackpotcoin/hrbjackpotcoin#21688 Note on SDK for macOS depends cross-compile (jarolrod)
- hrbjackpotcoin/hrbjackpotcoin#21709 Update reduce-memory.md and hrbjackpotcoin.conf -maxconnections info (jonatack)
- hrbjackpotcoin/hrbjackpotcoin#21710 update helps for addnode rpc and -addnode/-maxconnections config options (jonatack)
- hrbjackpotcoin/hrbjackpotcoin#21752 Clarify that feerates are per virtual size (MarcoFalke)
- hrbjackpotcoin/hrbjackpotcoin#21811 Remove Visual Studio 2017 reference from readme (sipsorcery)
- hrbjackpotcoin/hrbjackpotcoin#21818 Fixup -coinstatsindex help, update hrbjackpotcoin.conf and files.md (jonatack)
- hrbjackpotcoin/hrbjackpotcoin#21856 add OSS-Fuzz section to fuzzing.md doc (adamjonas)
- hrbjackpotcoin/hrbjackpotcoin#21912 Remove mention of priority estimation (MarcoFalke)
- hrbjackpotcoin/hrbjackpotcoin#21925 Update bips.md for 0.21.1 (MarcoFalke)
- hrbjackpotcoin/hrbjackpotcoin#21942 improve make with parallel jobs description (klementtan)
- hrbjackpotcoin/hrbjackpotcoin#21947 Fix OSS-Fuzz links (MarcoFalke)
- hrbjackpotcoin/hrbjackpotcoin#21988 note that brew installed qt is not supported (jarolrod)
- hrbjackpotcoin/hrbjackpotcoin#22056 describe in fuzzing.md how to reproduce a CI crash (jonatack)
- hrbjackpotcoin/hrbjackpotcoin#22080 add maxuploadtarget to hrbjackpotcoin.conf example (jarolrod)
- hrbjackpotcoin/hrbjackpotcoin#22088 Improve note on choosing posix mingw32 (jarolrod)
- hrbjackpotcoin/hrbjackpotcoin#22109 Fix external links (IRC, …) (MarcoFalke)
- hrbjackpotcoin/hrbjackpotcoin#22121 Various validation doc fixups (MarcoFalke)
- hrbjackpotcoin/hrbjackpotcoin#22172 Update tor.md, release notes with removal of tor v2 support (jonatack)
- hrbjackpotcoin/hrbjackpotcoin#22204 Remove obsolete `okSafeMode` RPC guideline from developer notes (theStack)
- hrbjackpotcoin/hrbjackpotcoin#22208 Update `REVIEWERS` (practicalswift)
- hrbjackpotcoin/hrbjackpotcoin#22250 add basic I2P documentation (vasild)
- hrbjackpotcoin/hrbjackpotcoin#22296 Final merge of release notes snippets, mv to wiki (MarcoFalke)
- hrbjackpotcoin/hrbjackpotcoin#22335 recommend `--disable-external-signer` in OpenBSD build guide (theStack)
- hrbjackpotcoin/hrbjackpotcoin#22339 Document minimum required libc++ version (hebasto)
- hrbjackpotcoin/hrbjackpotcoin#22349 Repository IRC updates (jonatack)
- hrbjackpotcoin/hrbjackpotcoin#22360 Remove unused section from release process (MarcoFalke)
- hrbjackpotcoin/hrbjackpotcoin#22369 Add steps for Transifex to release process (jonatack)
- hrbjackpotcoin/hrbjackpotcoin#22393 Added info to hrbjackpotcoin.conf doc (bliotti)
- hrbjackpotcoin/hrbjackpotcoin#22402 Install Rosetta on M1-macOS for qt in depends (hebasto)
- hrbjackpotcoin/hrbjackpotcoin#22432 Fix incorrect `testmempoolaccept` doc (glozow)
- hrbjackpotcoin/hrbjackpotcoin#22648 doc, test: improve i2p/tor docs and i2p reachable unit tests (jonatack)
