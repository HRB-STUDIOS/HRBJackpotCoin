HRBJackpotCoin Core version 0.13.2 is now available from:

  <https://hrbjackpotcoin.org/bin/hrbjackpotcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update hrbjackpotcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow hrbjackpotcoin-tx to create v2 transactions (hrbdrak)
