HRBJackpotCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hrbjackpotcoin/files/HRBJackpotCoin/hrbjackpotcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the HRBJackpotCoin
...
New/changed settings (command-line or hrbjackpotcoin.conf file)
--------------------------------------------------------
