HRBJackpotCoin Core version 0.9.2.1 is now available from:

  https://hrbjackpotcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 hrb to 0.01 hrb
...
- Fix "Start hrbjackpotcoin on system login"
