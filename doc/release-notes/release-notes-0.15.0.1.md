HRBJackpotCoin Core version *0.15.0.1* is now available from:

  <https://hrbjackpotcoin.org/bin/hrbjackpotcoin-core-0.15.0.1/>

and

  <https://hrbjackpotcoincore.org/bin/hrbjackpotcoin-core-0.15.0.1/>
