HRBJackpotCoin Core version 0.10.4 is now available from:

  <https://hrbjackpotcoin.org/bin/hrbjackpotcoin-core-0.10.4/>
...
- #6953 `43c2789` Split hrbjackpotcoin-tx into its own package
- #6953 `dfe0d4d` Include hrbjackpotcoin-tx binary on Debian/Ubuntu
