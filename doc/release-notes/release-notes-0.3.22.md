Download URL: https://sourceforge.net/projects/hrbjackpotcoin/files/HRBJackpotCoin/hrbjackpotcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 hrb fee schedule (users still pay 0.01 hrb per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #hrbjackpotcoin00 - #hrbjackpotcoin99
