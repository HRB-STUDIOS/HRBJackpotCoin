HRBJackpotCoin Core version 0.16.1 is now available from:

  <https://hrbjackpotcoincore.org/bin/hrbjackpotcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting hrbjackpotcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure hrbjackpotcoind processes are cleaned up when tests end (sdaftuar)
