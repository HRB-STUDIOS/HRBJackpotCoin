HRBJackpotCoin Core version *0.15.2* is now available from:

  <https://hrbjackpotcoincore.org/bin/hrbjackpotcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in hrbjackpotcoin-tx (TheBlueMatt)
