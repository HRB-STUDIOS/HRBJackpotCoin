#!/bin/sh
# Copyright (c) 2012-2021 The HRBJackpotCoin Core developers
...
GIT_TAG=""
GIT_COMMIT=""
if [ "${HRBJACKPOTCOIN_GENBUILD_NO_GIT}" != "1" ] && [ -e "$(command -v git)" ] && [ "$(git rev-parse --is-inside-work-tree 2>/dev/null)" = "true" ]; then
