...
# TestP2PConn: A peer we use to send messages to hrbjackpotcoind, and store responses.
...
class CompactBlocksTest(HRBJackpotCoinTestFramework):
    ...
    # This test actually causes hrbjackpotcoind to (reasonably!) disconnect us, so do this last.
    ...
    # hrbjackpotcoind's choice of nonce.
    ...
    # Test that hrbjackpotcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for hrbjackpotcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # hrbjackpotcoind will not send blocktxn responses for blocks whose height is
