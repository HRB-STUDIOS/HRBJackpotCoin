...
"""Test hrbjackpotcoin-cli"""

from decimal import Decimal
import re

from test_framework.blocktools import COINBASE_MATURITY
from test_framework.test_framework import HRB Jackpot CoinTestFramework
...
# The block reward of coinbaseoutput.nValue (50) HRB/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 HRB/block.
...
class TestHRB Jackpot CoinCli(HRB Jackpot CoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `hrbjackpotcoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and hrbjackpotcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and hrbjackpotcoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (HRB/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (HRB/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 HRB) to the default wallet.
            ...
            # Test hrbjackpotcoin-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test hrbjackpotcoin-cli -generate with -rpcwallet in multiwallet mode.
