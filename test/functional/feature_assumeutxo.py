#!/usr/bin/env python3
# Copyright (c) 2021-present The HRBJackpotCoin Core developers
...
to a hash that has been compiled into hrbjackpotcoind.
...
class AssumeutxoTest(HRBJackpotCoinTestFramework):
