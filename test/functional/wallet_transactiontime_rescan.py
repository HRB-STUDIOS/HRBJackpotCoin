...
class TransactionTimeRescanTest(HRBJackpotCoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine hrb and create transactions
        ...
        # generate some hrb to create transactions and check blockcount
        ...
        # send 10 hrb to user's first watch-only address
        self.log.info('Send 10 hrb to user')
        ...
        # send 5 hrb to our second watch-only address
        self.log.info('Send 5 hrb to user')
        ...
        # send 1 hrb to our third watch-only address
        self.log.info('Send 1 hrb to user')
