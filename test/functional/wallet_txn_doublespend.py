...
class TxnMallTest(HRBJackpotCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 hrb:
        ...
        # First: use raw transaction API to send 1240 hrb to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 hrb coin each
        ...
        # Node0's balance should be starting balance, plus 50hrb for another
        ...
        # Node0's total balance should be starting balance, plus 100hrb for
