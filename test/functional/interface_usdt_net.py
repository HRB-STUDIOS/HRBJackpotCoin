...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/hrbjackpotcoin/hrbjackpotcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(HRBJackpotCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our hrbjackpotcoind node")
