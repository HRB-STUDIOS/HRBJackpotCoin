...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HRBJackpotCoinTestFramework
    pass


class ExampleTest(HRBJackpotCoinTestFramework):
    # Each functional test is a subclass of the HRBJackpotCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        HRBJackpotCoinTestFramework class so other tests can use it."""
