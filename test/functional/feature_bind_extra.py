...
"""
Test starting hrbjackpotcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(HRBJackpotCoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that hrbjackpotcoind has bound on "::1" (for RPC) and "::" (for P2P).
