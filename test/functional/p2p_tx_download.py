#!/usr/bin/env python3
# Copyright (c) 2019-2021 The HRBJackpotCoin Core developers
...
class TxDownloadTest(HRBJackpotCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new hrbjackpotcoind instances, as setting mocktimes has long-term effects on when
