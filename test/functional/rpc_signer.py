...
Verify that a hrbjackpotcoind node can use an external signer command.
...
class RPCSignerTest(HRBJackpotCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart hrbjackpotcoind with -signer=<cmd>',
