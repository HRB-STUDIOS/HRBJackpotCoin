...
By default, hrbjackpotcoind will dump mempool on shutdown and
...
class MempoolPersistTest(HRBJackpotCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent hrbjackpotcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
