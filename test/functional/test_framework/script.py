...
This file is modified from python-hrbjackpotcoinlib.
"""
...
def bn2vch(v):
    """Convert number to hrbjackpotcoin-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in HRBJack codebase"""
    r = b''
