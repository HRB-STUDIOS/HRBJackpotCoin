...
class TestShell:
    """Wrapper Class for HRBJackpotCoinTestFramework.

    The TestShell class extends the HRBJackpotCoinTestFramework
    ...
    class __TestShell(HRBJackpotCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by HRBJackpotCoinTestFramework child class.
            self.num_nodes = 1
