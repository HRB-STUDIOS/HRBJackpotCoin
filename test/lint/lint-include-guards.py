...
HEADER_ID_PREFIX = 'HRBJACKPOTCOIN_'
HEADER_ID_SUFFIX = '_H'

EXCLUDE_FILES_WITH_PREFIX = ['contrib/devtools/hrbjackpotcoin-tidy',
                             'src/crypto/ctaes',
                             'src/leveldb',
                             'src/crc32c',
                             'src/secp256k1',
...
def _get_header_id(header_file: str) -> str:
    """ Helper function to get the header id from a header file
        ...
        eg: 'src/wallet/walletdb.h' -> 'HRBJACKPOTCOIN_WALLET_WALLETDB_H'
