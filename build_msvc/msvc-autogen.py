...
libs = [
    'libhrbjackpotcoin_cli',
    'libhrbjackpotcoin_common',
    'libhrbjackpotcoin_crypto',
    'libhrbjackpotcoin_node',
    'libhrbjackpotcoin_util',
    'libhrbjackpotcoin_wallet_tool',
    'libhrbjackpotcoin_wallet',
    'libhrbjackpotcoin_zmq',
    'bench_hrbjackpotcoin',
    'libtest_util',
]
...
def parse_config_into_hrb_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"HRBJackpotCoin Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/hrbjackpotcoin_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/hrbjackpotcoin_config.h'), "w", encoding="utf8") as hrb_config:
        hrb_config.writelines(template)
...
def main():
    parser = argparse.ArgumentParser(description='HRBJackpotCoin-core msbuild configuration initialiser.')
    ...
    parse_config_into_hrb_config()
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/hrbjackpotcoin_config.h'), os.path.join(SOURCE_DIR, 'config/hrbjackpotcoin-config.h'))
